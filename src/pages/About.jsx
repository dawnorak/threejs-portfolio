  ...
  return (
    <section className="max-container">
      ...
      <div className="py-16">
        ...
        <div className="mt-5 flex flex-col gap-3 text-slate-500">
          <p>Apart from the skills I have obtained during my learning journey as a student, I have also have a few opportunities to display my skills in the workfoce through internships. Here's a rowndown:</p>
        </div>
            ...
            <VerticalTimeline>
              {experiences.map((experience) => (
                <VerticalTimelineElement
                  ...
                  contentStyle={{borderBottom: '8px', borderStyle: 'solid', borderBottomColor: experience.iconBg, borderShadow: 'none'}}
                >
                  <div>
